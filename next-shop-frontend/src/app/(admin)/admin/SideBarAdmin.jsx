...
import { HiOutlineChevronRight, HiOutlineCube, HiOutlineHome, HiOutlineUsers, HiOutlineLogout, HiOutlineViewGrid, HiOutlineCollection } from 'react-icons/hi';
...
const sidebarRoutes = [
    ...
    {id:2, label: "داشبورد", url: "/admin", smallIcon: <HiOutlineViewGrid className='w-4 h-4 stroke-current' />,bigIcon: <HiOutlineViewGrid className='w-6 h-6 stroke-current ' /> },
    {id:3, label: "کاربران", url: "/admin/users", smallIcon: <HiOutlineUsers className='w-4 h-4 stroke-current' />,bigIcon: <HiOutlineUsers className='w-6 h-6 stroke-current ' /> },
    { id: 4, label: "محصولات", url: "/admin/products", smallIcon: <HiOutlineCube className='w-4 h-4 stroke-current' />, bigIcon: <HiOutlineCube className='w-6 h-6 stroke-current ' /> },
    {id:5, label: "دسته بندی‌ها", url: "/admin/categories", smallIcon: <HiOutlineCollection className='w-4 h-4 stroke-current' />,bigIcon: <HiOutlineCollection className='w-6 h-6 stroke-current ' /> }
]
