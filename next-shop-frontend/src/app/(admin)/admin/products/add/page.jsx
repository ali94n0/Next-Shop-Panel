...
import { useAddProduct } from "@/hooks/useProductAdmin";
...
function page() {
    ...
    return (
        <div className="container max-w-screen-md p-4  ">
            <h3 className="text-sm md:text-lg text-secondary-700 font-bold px-4 py-2 mb-4">افزودن محصول جدید</h3>
            <div className="flex flex-col gap-y-4 max-w-screen-sm rounded-md shadow-lg shadow-secondary-50/50 mx-auto">
                <ProductForm formik={formik} options={categories} isLoading={isLoading} isPending={isPending}/>
            </div>
